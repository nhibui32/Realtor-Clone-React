        ...
        <div  className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            {/* whitespace-nowrap to prevent them to go to the second line! */}
              ...
              <button type='submit' className='w-full bg-blue-600 text-white text-sm font-medium px-7 py-3 uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Send reset password</button>
